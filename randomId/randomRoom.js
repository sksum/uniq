...
console.log('_PLURALNOUN_ ',_PLURALNOUN_.length);
...
console.log('_VERB_ ',_VERB_.length);
/**
 * The list of adverbs.
 * @const
 */
...
console.log('_ADVERB_ ',_ADVERB_.length);
...
console.log('_ADJECTIVE_ ', _ADJECTIVE_.length);
